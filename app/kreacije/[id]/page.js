...
export default function ProjectDetails() {
      ...
      <AnimatePresence>
        {currentImageIndex !== null && (
          ...
          >
            ...
            {/* Vidljive strelice za prev/next */}
            {imagesToShow.length > 1 && (
              <>
              {/*   <button
                  onClick={prevImage}
                  aria-label="Prethodna slika"
                  className="absolute left-2 md:left-8 top-1/2 -translate-y-1/2 z-20 w-14 h-14 bg-white/80 hover:bg-white text-slate-900 hover:text-pink-600 rounded-full flex items-center justify-center shadow-lg border border-slate-200 transition-all duration-200 active:scale-95 focus:outline-none focus:ring-2 focus:ring-pink-400"
                  style={{ fontSize: 32 }}
                >
                ...
                <button
                  ...
                  className="absolute right-2 md:right-8 top-1/2 -translate-y-1/2 z-20 w-14 h-14 bg-white/80 hover:bg-white text-slate-900 hover:text-pink-600 rounded-full flex items-center justify-center shadow-lg border border-slate-200 transition-all duration-200 active:scale-95 focus:outline-none focus:ring-2 focus:ring-pink-400"
                  style={{ fontSize: 32 }}
                >
  ...
  className="absolute left-6 md:left-12 top-1/2 -translate-y-1/2 z-20 
             ...
             bg-white/80 hover:bg-white text-slate-900 hover:text-pink-600 
...
>
  <IoChevronForwardOutline size={28} />
            ...
            >
              {imagesToShow[currentImageIndex] && imagesToShow[currentImageIndex].startsWith("http") ? (
                <img
